            ...
            {[...data].sort((a, b) => a.order - b.order).map(obj => (
              <Row key={obj._id}>
                <Col className="timeline-dot-col" xs={2}>
                  <TimelineDot
                    primaryColor={obj.style.primaryColor}
                    secondaryColor={obj.style.secondaryColor}
                  />
                </Col>
                <Col className="timeline-card-col" xs={12} sm={10}>
                  <TimelineCard
                    ...
                    icon={obj.image}
                    bannerImage={
                      obj.style.bannerImage == null
                        ? `linear-gradient(135deg, ${obj.style.primaryColor}, ${
                            obj.style.secondaryColor
                          })`
